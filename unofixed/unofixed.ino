...
/* Include all necessary libraries. Make sure the .cpp and .h files are in the Arduino
 IDEs libraries folder on your computer */
...
#define CC3000_IRQ   3  
// MUST be an interrupt pin! Replaces all ADA… 
...
void setup(void)
{
  ...
  //If wifi board cant be initialized, go into infinite loop. Program will need to be restarted.  
  if (!cc3000.begin())
  {
